/**
 *	@file Z-Engine\Z-Engine\Projects\Windows\Implementations\OpenGLES2Renderer\OpenGLES2Renderer.h
 *	@brief 
 *	
 *	Copyright()
 ...
 *	
 *********************************************************************************************/
#ifndef _OPENGLES2RENDERER_H__Included_2051281620
#define _OPENGLES2RENDERER_H__Included_2051281620
...
namespace ZGE
{
	...
	class COpenGLES2Renderer : public IRendererInterface
	{
	public:
		COpenGLES2Renderer(void);
		~COpenGLES2Renderer(void);
		/*
	...
	// Renderer context 
		...
		COpenGLESVertexDeclarationManager* m_pDeclManager;	//!< The vetex declaration manager implementation.
...
#endif //_OPENGLES2RENDERER_H__Included_2051281620
